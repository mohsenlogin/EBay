<%@ Page Title="" Language="C#" MasterPageFile="~/CityAffairs/Manager.Master" AutoEventWireup="true" CodeBehind="AllLegalDocs.aspx.cs" Inherits="LMS.CityAffairs.AllLegalDocs" %>
      ...
      <table style="width:100%; text-align:center; direction:rtl;">
        ...
        <tr>
            <td>
                ...
                <asp:DropDownList ID="ddlMunicipality" runat="server" DataSourceID="sdsMunicipalities" DataTextField="Name" DataValueField="Id" Height="50px" Font-Names="DefaultFont" OnSelectedIndexChanged="ddlMunicipality_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList> </td>
            <td style="width:100%">
               ...
               <asp:ImageButton ImageUrl="../Images/search.png"  style="vertical-align:middle;width:50px;position:relative; right:-70px;top:1px; " runat="server" BorderWidth="0" ID="ibtnSearch" OnClick="ibtnSearch_Click" /> 
        ...
        <tr>
            <td colspan="2" style="text-align:center;">
                ...
                <div class ="roundCorners" style="width:95%; text-align:center;direction:rtl;">
